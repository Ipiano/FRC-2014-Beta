 ...
 *
 */
public class  SetDumperLoad extends Command {
    public SetDumperLoad() {
    ...
    protected void initialize() {
        Robot.dumper.getArm().setSetpoint(Robot.dumper.ARM_LOAD);
        Robot.dumper.getArm().enable();
        Robot.dumper.getBucket().setSetpoint(Robot.dumper.BUCKET_LOAD);
